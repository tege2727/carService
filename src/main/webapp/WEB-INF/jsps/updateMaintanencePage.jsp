...
<form action="updateMaintenance" method="get">
<table>
<tr> <td>İşlem Detayları:     </td>       <td><input type="text"   name="processDetails"  placeholder="${savedMaintenance.processDetails}"  > </td>        </tr>
<tr> <td>İşlem KM :           </td>       <td><input type="text"   name="processKm"       placeholder="${savedMaintenance.processKm}" >      </td>        </tr>
<tr> <td>Açıklama:            </td>       <td><input type="text"   name="comments"        placeholder="${savedMaintenance.comments}">       </td>        </tr>
<tr> <td>Giriş:               </td>       <td><input type="submit" value="Kaydet">        </td>        </tr> 

</table>

<input type="hidden" name="maintenanceId" value="${savedMaintenance.id}" />
